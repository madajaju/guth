module.exports = {
    ...
    description: 'Publish Episode is the description',
    method: "episode/list",
    actors: {
        'Actor': 'uses',
    },
    steps: [
        { action: 'podcast/create', parameters: {name:'RSD', file:'./templates/podcast.yml'}},
        { action: 'episode/create', parameters: {name:'RSD-A1', file:'./templates/episode.yml'}},
        { action: 'podcast/addepisodes', parameters: { name: 'RSD', items:'RSD-A1'}},
        { action: 'episode/publish', parameters: { id:'RSD-A1'}},
        { action: 'episode/publish', parameters: { id:'RSD-A1', channels:'facebook1'}},
        ...
        { action: 'podcast/addepisodes', parameters: { name: 'EDT', items:'EDT-47'}},
        ...
        { action: 'artifact/update', parameters: {name:'thumbnail', type:'image', url:'https://darpai-my.sharepoint.com/:i:/g/personal/darren_pulsipher_org/EcEpyL2ck7hIhlm6HoXgWnQBkNQZkUKWL0Gj0OOuEMkceA?e=0PlsHr'}},
        ...
        { action: 'episode/publish', parameters: { id:'EDT-47'}},
    ]
};
